    ...
    FunSpec(body = {
        test(name = "Composables in components packages are internal") {
            Konsist
                ...
                .assertFalse(
                    additionalMessage = "Composables in a 'components' package must be 'internal'"
                ) { function ->
        ...
        test(name = "Preview composables are private") {
            Konsist
                ...
                .assertTrue(
                    additionalMessage = "@Preview composables must be 'private'"
                ) { function ->
        ...
        test(name = "PreviewParameterProvider subclasses are internal (except in utils module)") {
            Konsist
                ...
                .assertTrue(
                    additionalMessage = "PreviewParameterProvider subclasses must be 'internal'"
                ) { clazz ->
